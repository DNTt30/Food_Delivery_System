...
| **Tuần 3** | **Thiết kế Lớp & Tạo cơ sở Code** | - Class Diagram đầy đủ (.drawio/.png)<br>- Khung mã nguồn phân tầng (Code Skeleton) | ✅<br>**Đầy đủ 100%** | - Sơ đồ lớp: [ClassDiagram_Updated.drawio](file:///d:/review%20SPRING_BOOT/springBoot_template-main/Food_Delivery_System/ClassDiagram_Updated.drawio)<br>- Tài liệu mô tả: [ClassDiagram_Tuan3_Team14.docx](file:///d:/review%20SPRING_BOOT/springBoot_template-main/Food_Delivery_System/Documents/ClassDiagram_Tuan3_Team14.docx) (16 Entities + 9 Enums + 13+ quan hệ). | *Đã hoàn thành.* |
