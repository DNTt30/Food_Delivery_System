...
3.  **Tạo file Biên bản họp nhóm:** Copy nội dung **Phần A.1** vào file Word lưu tên `BienBanHop_Tuan1_Team12.docx`.
4.  **Tạo file Kịch bản Use Case:** Copy nội dung **Phần B** vào file Word lưu tên `KichBan_UseCase_Tuan2_Team12.docx`.
